...
public class TrazoFig : MonoBehaviour
{
    ...
    [Header("Manager")]
    public ManagerFig managerFig;
    public int indiceFig;
    ...
    void EvaluateCompletion()
    {
        ...
        Debug.Log("HitCount: " + hitCount + " / " + samplePoints.Count);
        ...
        if (percent >= requiredPercentage)
        {
            ...
            if (managerFig != null)
                managerFig.CompletarFig(indiceFig);
        }
    }
